...
import 'package:lombard_ui_new/il_one_button_popup.dart';
...
import 'package:lombard_ui_new/il_two_button_popup.dart';
import 'package:url_launcher/url_launcher.dart';

void main() async {
  WidgetsFlutterBinding.ensureInitialized();
  runApp(MaterialApp(
    home: const LombardUITestPage(),
...
class _LombardUITestPageState extends State<LombardUITestPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(color: ILColors.kWhiteColor),
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return ILTwoButtonPopUp(
                        content: Image.network(
                            "https://th.bing.com/th/id/OIG.cDFmhLOsoljMRPbL0EtY?w=270&h=270&c=6&r=0&o=5&dpr=1.5&pid=ImgGn"),
                        icon: Icon(Icons.info_outline,
                            color: ILColors.kPrimaryOrangeColor),
                        title: "Roadside Assistance",
                        description:
                            "this should be the marked answer cause the question is about how to center a text in horizontal and vertical. Thank you! – aligur Feb 1, 2020 at 13:15s the answer guys, just wondering why my text was not aligning with a bigger font size, Turns out that center it's weird with text and there is a breakpoint in wich will ignore the text size. Align seems not to have this issue.. – RegularGuyAug 27, 2020 at 15:25",
                        buttonWidth: 130,
                      );
                    },
                  );
